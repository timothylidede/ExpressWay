...
public class DestinationStation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_destination_station);
        ...
        mDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String destination_station = mPickText.getText().toString().trim();
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(DestinationStation.this, "Try Again", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
